...
export const queryClient = new QueryClient({
  defaultOptions: {
    queries: {
      ...
      //
      // This is a DEFAULT, and a small number of identity/ownership queries opt
      // out of it per-query (see catalogQueries.ts) because for those, showing a
      // previous launch's data is a correctness bug rather than a stale-but-fine
      // read. Pinned by scripts/check-perf-regressions.cjs — do not widen here.
